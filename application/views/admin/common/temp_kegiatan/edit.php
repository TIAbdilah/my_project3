...
<div class="widget widget-table action-table">
    ...
    <div class="widget-content"><br>
        <form class="bs-docs-example form-horizontal" action="<?php echo site_url('common/temp_kegiatan/process/edit/' . $row->id); ?>" method="POST">
                ...
                <div class="controls">
                    <select class="input-xlarge" name="inpKodeUnit">
                        ...
                        foreach ($SIList_unit as $row_1) {
                            echo "<option value=\"" . $row_1->kode_unit . "\"".set_select('inpKodeUnit', $row_1->id, $row_1->kode_unit == $row->kode_unit).">" . $row_1->kode_unit . " - " . $row_1->nama_unit . "</option>";
                        }
                        ?>
                    </select>
                </div>
                ...
                <div class="controls">
                    <select class="input-xlarge" name="inpKoordinator">
                        ...
                        foreach ($SIList_pegawai as $row_2) {
                            echo "<option value=\"" . $row_2->nama . "\"".set_select('inpKoordinator', $row_2->id, $row_2->id == $row->koordinator).">" . $row_2->nama . "</option>";
                        }
                        ?>
                    </select>
                </div>
                ...
                <div class="controls">
                    <select class="input-xlarge" name="inpPenanggungJawab">
                        ...
                        foreach ($SIList_pegawai as $row_3) {
                            echo "<option value=\"" . $row_3->nama . "\"".set_select('inpPenanggungJawab', $row_3->id, $row_3->id == $row->penanggung_jawab).">" . $row_3->nama . "</option>";
                        }
                        ?>
                    </select>
                </div>
