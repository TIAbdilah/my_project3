...
<div class="widget widget-table action-table">
    ...
    <div class="widget-content" style="padding: 10px;">
        ...
        <form class="bs-docs-example form-horizontal" action="<?php echo site_url('transaksi/pengajuan_honorarium/process/edit/' . $data->id) ?>" method="POST">            
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="inNamaKegiatan" id="inNamaKegiatan" class="input-xlarge" value="<?php echo $data->kegiatan ?>"/>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="inAcara">Acara</label>
                <div class="controls">
                    <input name="inAcara" id="inAcara" class="input-xlarge" value="<?php echo $data->acara ?>"/>
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="inPeriodePembayaran" >Periode Pembayaran</label>
                <div class="controls">
                    <input type="text" class="inpTanggal" id="inPeriodePembayaran" name="inPeriodePembayaran" value="<?php echo format_date($data->periode_pembayaran) ?>"/>
                </div>
            </div>
            <div class="control-group">
                <div class="controls">  
