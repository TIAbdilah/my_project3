            ...
            <table border="0" style="width: 100%">        
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" placeholder="Nomor" id="inNomorBuktiRefresentatif" name="inNomorBuktiRefresentatif" value="<?php echo $data_bukti->nomor_representatif ?>"/></td>
                        <td><input type="text" placeholder="Jumlah" id="inJumlahRefresentatif" name="inJumlahRefresentatif" value="<?php echo $data_bukti->jumlah_representatif ?>"/></td>
                        <td><input type="text" placeholder="Selisih" id="inSelisihRefresentatif" name="inSelisihRefresentatif" value="<?php echo number_format($data_detail->representatif - $data_bukti->jumlah_representatif) ?>"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" placeholder="Nomor" id="inNomorBuktiDiklat" name="inNomorBuktiDiklat" value="<?php echo $data_bukti->nomor_diklat ?>"/></td>
                        <td><input type="text" placeholder="Jumlah" id="inJumlahDiklat" name="inJumlahDiklat" value="<?php echo $data_bukti->jumlah_diklat ?>"/></td>
                        <td><input type="text" placeholder="Selisih" id="inSelisihDiklat" name="inSelisihDiklat" value="<?php echo number_format($data_detail->diklat - $data_bukti->jumlah_diklat) ?>"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" placeholder="Nomor" id="inNomorBuktiSewa" name="inNomorBuktiSewa" value="<?php echo $data_bukti->nomor_sewa ?>"/></td>
                        <td><input type="text" placeholder="Jumlah" id="inJumlahSewa" name="inJumlahSewa" value="<?php echo $data_bukti->jumlah_sewa ?>"/></td>
                        <td><input type="text" placeholder="Selisih" id="inSelisihSewa" name="inSelisihSewa" value="<?php echo number_format($data_detail-> sewa - $data_bukti->jumlah_sewa) ?>"/></td>
                    </tr>
                    <tr>
