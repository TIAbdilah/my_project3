<html>
    ...
    <table style="width:100%">
        <tr>
            ...
            <td width="50%">: <?php echo $data_report->nomor_pengajuan ?></td>
            <td width="30%" style="border: solid #000 1px" align="center" rowspan="2">MAK<br><?php echo $data_report->kode_kegiatan; ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="3" align="center"><strong>NOTA DINAS</strong></td>
        </tr>    
        <tr>
    ...
    <table style="width:100%;border-collapse: collapse">
        <tr><td style="border-bottom: solid #000 1px">&nbsp;</td></tr>
        <tr><td>&nbsp;</td></tr>
    </table>
